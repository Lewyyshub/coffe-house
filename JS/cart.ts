...
const cartIcon = document.getElementById("cart-icon") as HTMLDivElement;
...
confirmOrderBtn.addEventListener("click", async () => {
  ...
  try {
    const res = await fetch(
      "http://coffee-shop-be.eu-central-1.elasticbeanstalk.com/api/orders",
      {
        method: "POST",
        headers: {
